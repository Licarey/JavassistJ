package com.example.record.helper

import com.example.record.BusInfo
...
public class BusHelper {
    final static String OkBusAnnotation = "cn.com.careyli.annotation.Bus"
    final static String OkBusRegisterAnnotation = "cn.com.careyli.annotation.BusRegister"
    final static String OkBusUnRegisterAnnotation = "cn.com.careyli.annotation.BusUnRegister"
    ...
    static String getRegisterEventMethodStr(BusInfo mBusInfo) {
        String CreateStr = "";
        mBusInfo.clazz.addInterface(mBusInfo.clazz.classPool.get("com.example.liming.validateproject.Event"));//为当前的类添加时间处理的接口
